        ...
        <AnimationContainer customClassName="w-full flex flex-col gap-5 mb-8">
          <div className="relative p-8 lg:p-12 bg-gradient-to-br from-gray-950/98 via-gray-900/95 to-gray-950/98 rounded-3xl shadow-2xl backdrop-blur-xl overflow-hidden border border-gray-700/40 hover:border-primary-400/60 transition-all duration-1000 group transform hover:scale-[1.01]">
            ...
            <div className="absolute inset-0 opacity-40 pointer-events-none">
              <div
                className="absolute top-[15%] left-[20%] w-3 h-3 bg-emerald-400/70 rounded-full animate-bounce"
                style={{ animationDelay: '0s', animationDuration: '2.5s' }}
              ></div>
              <div
                className="absolute top-[70%] right-[25%] w-2 h-2 bg-blue-400/70 rounded-full animate-bounce"
                style={{ animationDelay: '0.8s', animationDuration: '3s' }}
              ></div>
              <div
                className="absolute bottom-[20%] left-[35%] w-2.5 h-2.5 bg-purple-400/70 rounded-full animate-bounce"
                style={{ animationDelay: '1.2s', animationDuration: '2.8s' }}
              ></div>
              <div
                className="absolute top-[45%] right-[15%] w-1.5 h-1.5 bg-cyan-400/70 rounded-full animate-bounce"
                style={{ animationDelay: '1.8s', animationDuration: '2.2s' }}
              ></div>
              <div
                className="absolute bottom-[60%] left-[70%] w-1 h-1 bg-pink-400/70 rounded-full animate-bounce"
                style={{ animationDelay: '2.2s', animationDuration: '3.5s' }}
              ></div>

              {/* Additional tech particles for IoT/Fintech theme */}
              <div
                className="absolute top-[30%] left-[60%] w-2 h-2 bg-amber-400/60 rounded-full animate-pulse"
                style={{ animationDelay: '0.5s', animationDuration: '2s' }}
              ></div>
              <div
                className="absolute bottom-[40%] right-[40%] w-1.5 h-1.5 bg-teal-400/60 rounded-full animate-pulse"
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none">
              <div
                className="absolute inset-0 rounded-3xl bg-gradient-to-r from-emerald-500/20 via-blue-500/20 to-purple-500/20 animate-pulse"
              ...
              <div className="flex items-start gap-6 mb-10">
                ...
                <div className="flex-1">
                  <h2 className="text-3xl lg:text-5xl xl:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-emerald-200 via-blue-200 to-purple-200 mb-6 leading-tight">
                    ...
                    <span
                      className="inline-block bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-pulse"
                      style={{
                        animationDuration: '3s',
                        animationDelay: '1.5s'
                      }}
                  ...
                  <p className="text-xl lg:text-2xl text-gray-200 leading-relaxed">
                    ...
                    -
                    <span className="inline-block mx-3 px-4 py-2 bg-gradient-to-r from-emerald-500/30 to-teal-500/30 text-emerald-200 rounded-2xl text-lg font-semibold border border-emerald-500/40 backdrop-blur-sm shadow-lg transform hover:scale-105 transition-all duration-300 cursor-default">
                      {' '}
                      IoT solutions
                    </span>
                    ,
                    <span className="inline-block mx-3 px-4 py-2 bg-gradient-to-r from-blue-500/30 to-indigo-500/30 text-blue-200 rounded-2xl text-lg font-semibold border border-blue-500/40 backdrop-blur-sm shadow-lg transform hover:scale-105 transition-all duration-300 cursor-default">
                      {' '}
                      fintech innovation
                    </span>
                    , and everything
                    <span className="inline-block mx-3 px-4 py-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 text-purple-200 rounded-2xl text-lg font-semibold border border-purple-500/40 backdrop-blur-sm shadow-lg transform hover:scale-105 transition-all duration-300 cursor-default">
                      {' '}
                      next-gen tech
                    </span>
                    .
            ...
            <div className="flex justify-center mt-10">
              ...
              >
                ...
                <div className="relative flex items-center gap-4 z-10">
                  ...
                  <svg
                    className="w-5 h-5 transition-all duration-500 group-hover:translate-x-2 group-hover:scale-125"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12 pt-10 border-t border-gray-600/50">
              <div className="group/stat relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-2xl p-6 backdrop-blur-sm border border-gray-700/50 hover:border-emerald-500/50 transition-all duration-500 hover:transform hover:scale-105 cursor-default">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-sm lg:text-base font-bold text-gray-300 group-hover/stat:text-white transition-colors duration-300 uppercase tracking-wider">
                    Tech Articles
                  </div>
              ...
              <div className="group/stat relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-2xl p-6 backdrop-blur-sm border border-gray-700/50 hover:border-blue-500/50 transition-all duration-500 hover:transform hover:scale-105 cursor-default">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div
                    className="absolute top-3 right-3 w-2 h-2 bg-blue-400 rounded-full animate-pulse opacity-70"
              ...
              <div className="group/stat relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-2xl p-6 backdrop-blur-sm border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:transform hover:scale-105 cursor-default">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div
                    className="absolute top-3 right-3 w-2 h-2 bg-purple-400 rounded-full animate-pulse opacity-70"
                ...
                <div className="relative z-10 text-center">
                  <div className="text-3xl lg:text-4xl xl:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-cyan-600 group-hover/stat:from-cyan-300 group-hover/stat:to-cyan-500 transition-all duration-500 mb-2">
                    {Math.round(
                      posts.reduce(
                        (acc, post) =>
                          acc + parseInt(post.readingTime.split(' ')[0]),
                        0
                      ) / posts.length
                    )}
                  </div>
                  ...
                  <div
                    className="absolute top-3 right-3 w-2 h-2 bg-cyan-400 rounded-full animate-pulse opacity-70"
