...
const AllFavTechs: React.FC = () => {
  ...
  return (
    <div>
      <MotionP
        className="text-base text-center lg:text-start mb-2.5 text-gray-600"
      ...
      <div className="flex text-[#444] justify-center items-center lg:items-start mb-5 mx-auto lg:mx-0">
        ...
        >
          ...
          <MotionLi 
            className="transition duration-200 hover:text-[#FFFFFF]"
            variants={animation} 
            initial="hide" 
            animate="show"
          >
          ...
          <MotionLi 
            className="transition duration-200 hover:text-[#8cc84b]"
            variants={animation} 
            initial="hide" 
            animate="show"
          >
