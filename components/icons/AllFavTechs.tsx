...
const AllFavTechs: React.FC = () => {
  // Cast motion components as any to avoid TypeScript errors with className prop
    ...
    <div>
      ...
      <div className="flex text-[#444] justify-center items-center lg:items-start mb-5 mx-auto lg:mx-0">
        ...
        >
          ...
          <li className="transition duration-200 hover:text-[#61DAFB]">
            <motion.li variants={animation} initial="hide" animate="show">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="transition duration-200 hover:text-[#FFFFFF]">
            <motion.li variants={animation} initial="hide" animate="show">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="transition duration-200 hover:text-[#06B6D4]">
            <motion.li variants={animation} initial="hide" animate="show">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="transition duration-200 hover:text-[#0055FF]">
            <motion.li variants={animation} initial="hide" animate="show">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <path d="M4 0h16v8h-8zM4 8h8l8 8H4zM4 16h8v8z"></path>4
                </svg>
              </div>
            </motion.li>
          </li>

          <li className="transition duration-200 hover:text-[#8cc84b]">
            <motion.li variants={animation} initial="hide" animate="show">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
