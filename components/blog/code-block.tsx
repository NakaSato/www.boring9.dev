  ...
  useEffect(() => {
    ...
    codeBlocks.forEach((codeBlock) => {
      ...
      copyButton.className =
        'copy-code-button absolute top-2 right-2 p-2 rounded-md bg-gray-700 hover:bg-gray-600 transition-colors duration-200 opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none';
