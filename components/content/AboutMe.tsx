...
const AboutMe = () => {
  return (
    <AnimationContainer customClassName="w-full">
      <div className="w-full p-6 bg-gray-900/50 rounded-xl border border-gray-700 shadow-lg">
        <h2 className="font-bold text-2xl md:text-3xl tracking-tight mb-8 text-gray-100 text-start bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent">
          About me
        </h2>
