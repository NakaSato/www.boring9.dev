    ...
    <>
      ...
      {isMenuMounted && (
        <ul
          className={cn(
            styles.menu,
            'flex flex-col items-start justify-center absolute right-0 backdrop-blur-lg bg-gray-900/90 text-end p-6 rounded-lg shadow-xl border border-gray-800 z-50',
